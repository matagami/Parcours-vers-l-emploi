...
export const PhoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.211-.99-.554-1.33l-2.16-2.16a1.5 1.5 0 0 0-2.12 0l-1.152 1.152a11.25 11.25 0 0 1-6.316-6.316l1.152-1.152a1.5 1.5 0 0 0 0-2.12L6.88.786A1.5 1.5 0 0 0 5.546.236H4.174A2.25 2.25 0 0 0 1.926 2.5v2.25Z" />
  </svg>
);
